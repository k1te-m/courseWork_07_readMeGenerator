...
const questions = [
  ...
  },
  {
    type: "input",
    message:
      "If necessary, please describe the installation steps required for your project.",
    name: "installation",
  },
  {
    type: "input",
    message:
      "If applicable, please provide any examples of how to use your project.",
    name: "usage",
  },
  {
    type: "list",
  ...
  },
  {
    type: "input",
    message:
      "If applicable, how can other developers contribute to your project?",
    name: "contributing",
  },
  {
    type: "input",
    message:
      "Please provide any tests along with instructions on how to run them for your project.",
    name: "tests",
  },
  {
    type: "input",
    message:
      "If desired, please provide your email address for any questions users may have.",
    name: "questions",
  },
];
